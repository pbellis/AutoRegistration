#DEPENDENCIES_ROOT = C:/dependencies
#DEPENDENCIES_INCLUDE = $$(DEPENDENCIES_ROOT)/include
#DEPENDENCIES_LIB64 = $$(DEPENDENCIES_ROOT)/lib/windows/x64
#DEPENDENCIES_BIN = $$(DEPENDENCIES_ROOT)/bin

################################
# WJ's PCL codes related : Begin
################################
