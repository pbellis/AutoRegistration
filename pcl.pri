...
# Boost
#--------------------------------------------------------
INCLUDEPATH += $$(PCL)\3rdParty\Boost\include\boost-1_61
INCLUDEPATH += $$(PCL)\3rdParty\Boost\include\boost-1_61\boost
DEPENDPATH += $$(PCL)\3rdParty\Boost\lib\

win32:CONFIG(release, debug|release): LIBS += -L$$(PCL)\3rdParty\Boost\lib\ -llibboost_wserialization-vc140-mt-1_61\
...
else:win32:CONFIG(debug, debug|release): LIBS += -L$$(PCL)\3rdParty\Boost\lib\ -llibboost_wserialization-vc140-mt-gd-1_61\
...
# Eigen
#--------------------------------------------------------
INCLUDEPATH += $$(PCL)\3rdParty\Eigen\eigen3\

# FLANN
#--------------------------------------------------------
INCLUDEPATH += $$(PCL)\3rdParty\FLANN\include\

DEPENDPATH += $$(PCL)\3rdParty\FLANN\lib\
win32:CONFIG(debug, debug|release): LIBS += -L$$(PCL)\3rdParty\FLANN\lib\ -lflann-gd \
        -lflann_s-gd \
        -lflann_cpp_s-gd
win32:CONFIG(release, debug|release): LIBS += -L$$(PCL)\3rdParty\FLANN\lib\ -lflann \
        -lflann_s \
        -lflann_cpp_s

# VTK
#--------------------------------------------------------
INCLUDEPATH += $$(PCL)\3rdParty\VTK\include\vtk-7.0
DEPENDPATH  += $$(PCL)\3rdParty\VTK\lib

win32:CONFIG(release, debug|release): LIBS += -L$$(PCL)\3rdParty\VTK\lib -lvtksys-7.0 \
        -lvtkFiltersSMP-7.0 \
        ...
        -lvtkCommonMath-7.0 \
        -lvtkCommonCore-7.0
win32:CONFIG(debug, debug|release): LIBS += -L$$(PCL)\3rdParty\VTK\lib -lvtksys-7.0-gd \
...
# OPEN NI 2
#--------------------------------------------------------
INCLUDEPATH += $$(OPENNI)/Include
DEPENDPATH  += $$(OPENNI)/Lib

win32: LIBS += -L$$(OPENNI)/Lib -lOpenNI2

# PCL
#--------------------------------------------------------
INCLUDEPATH += $$(PCL)\include\pcl-1.8\
DEPENDPATH  += $$(PCL)\lib\

win32:CONFIG(release, debug|release): LIBS += -L$$(PCL)\lib\ -lpcl_io_release \
    -lpcl_io_ply_release \
...
else:win32:CONFIG(debug, debug|release): LIBS += -L$$(PCL)\lib\ -lpcl_io_debug \
    -lpcl_io_ply_debug \
    -lpcl_filters_debug \
    -lpcl_kdtree_debug \
